...
# GLOBAL VARIABLES  
PROMPT = ("a cat dressed as deadpool holding a sign saying: Yo, Andy!  Flux?")
...
SEED = 42  
RANDOMIZE_SEED = True  
NUMBER_OF_LOOPS = 50  # Default number of image creations  
...
def main():  
    ...
    base_seed = random.randint(0, 1000000) if RANDOMIZE_SEED else SEED
